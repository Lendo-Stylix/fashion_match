...
CATEGORIES = [
    ...
    {"name": "Áo Thể Thao Nam", "slug": "ao-the-thao-nam"},
...
def is_excluded(title: str, url: str) -> bool:
    ...
    for kw in EXCLUDE_KEYWORDS:
        if kw in title_l or kw in url_l:
            # check boundaries for English keywords to avoid false positives (e.g. baby tee)
...
def main():
    ...
    for cat in CATEGORIES:
        ...
        category_seen = set(results[name])
        page = 1
        empty_pages = 0
        ...
        while True:
            ...
            page_added = 0
            for pro in pros:
                # Extract variation links if available
                ...
                if var_links:
                    ...
                    # Fallback to base product details
            ...
            # If a page had less than 24 products, it's probably the last page
            if len(pros) < 24:
