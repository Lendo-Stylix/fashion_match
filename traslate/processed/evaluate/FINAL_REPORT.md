...
*   🥇 **Qwen3-VL 8B Instruct (Quán quân - 0.79/1.0)**: Thể hiện năng lực tư vấn vượt trội, bám sát tốt ngữ cảnh tài liệu RAG, trích dẫn chuẩn xác và đưa ra câu trả lời có tính thẩm mỹ thời trang cao nhất.
...
*   🥉 **Qwen3.5 9B Causal (Hạng ba - 0.76/1.0)**: Đạt độ chính xác cực cao trong việc trích xuất và gán link nguồn tương ứng với danh mục câu hỏi.
...
| Mô Hình | Retrieval | Citation | Fashion QA | Faithfulness | Hallucination | **Điểm TB Cộng** | **Điểm Thô TB** |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
...
### 3.1. Knowledge Retrieval (Truy xuất Tri thức)
*Đo lường khả năng tìm kiếm và áp dụng thông tin sản phẩm/quy tắc phối đồ từ ngữ cảnh.*
*   **Dòng Qwen (Đạt từ 0.60 - 0.67)**: Tìm kiếm và trích xuất thông tin linh hoạt, kết nối tốt các quy định thời trang vào câu trả lời cá nhân hóa cho người dùng.
...
### 3.2. Citation Accuracy (Độ chính xác trích dẫn)
*Đo lường tính chính xác của các link URL nguồn được gán ở cuối câu trả lời.*
*   **Qwen3.5 9B dẫn đầu (0.93)**: Ghép đúng danh mục và gán chuẩn xác URL liên quan (đạt tỷ lệ chính xác gần như tuyệt đối).
*   **Gemma4 (0.47)**: Mất điểm nhiều do các câu từ chối trả lời không đính kèm link trích dẫn.
...
*   **Ưu điểm**: Định dạng đầu ra rất ổn định, trích xuất link chính xác nhất hệ thống (0.93).
